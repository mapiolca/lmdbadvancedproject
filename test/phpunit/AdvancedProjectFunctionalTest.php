...
/**
 * Class AdvancedProjectFunctionalTest
 *
...
class AdvancedProjectFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	private static $module_id = 302502; // TODO: autodetect?
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modLmdbAdvancedProject')->click();
		} else {
			// Disable the module
			$this->byHref('modLmdbAdvancedProject')->click();
			// Reenable the module
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modLmdbAdvancedProject_AdvancedProjectTriggers.class.php',
