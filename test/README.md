...
Aucun navigateur connecté à une instance servant ce patch n’a été validé ; aucun déploiement n’est inclus. La lecture des tags v20–v24 et l’exécution de fixtures sous PHP 8.4.22 ne constituent pas une certification de toutes les combinaisons ERP/PHP/Multicompany. Les résultats datés figurent dans [le compte rendu 1.4.1](../doc/VALIDATION_COST_VALUATION.md).
